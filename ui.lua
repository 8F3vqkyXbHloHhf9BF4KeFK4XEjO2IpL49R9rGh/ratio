-- If you're looking at this, I don't wanna have to deal with preloadasync and any new methods of GUI detection. This is a good Drawing UI Library (Splix)
...
--local themes = {}
local theme = {
    accent = Color3.fromRGB(212, 204, 255),
